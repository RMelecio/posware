...
<!-- Themify icon-->
<link rel="stylesheet" type="text/css" href="{{ asset('template/css/themify.css') }}">
<!-- Flag icon-->
<link rel="stylesheet" type="text/css" href="{{ asset('template/css/flag-icon.css') }}">
<!-- Feather icon-->
<link rel="stylesheet" type="text/css" href="{{ asset('template/css/feather-icon.css') }}">
<!-- Plugins css start-->
<link rel="stylesheet" type="text/css" href="{{ asset('template/css/animate.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('template/css/chartist.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('template/css/date-picker.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('template/css/prism.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('template/css/vector-map.css') }}">
<!-- Plugins css Ends-->
<!-- Bootstrap css-->
